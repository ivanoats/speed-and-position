...
describe('LocationPermissionPrompt', () => {
  it('should render the welcome message', () => {
    ...
    render(<LocationPermissionPrompt onRequestPermission={mockOnRequestPermission} />)
  ...
  it('should explain what the app does', () => {
    ...
    expect(screen.getByText(/shows you how fast you're going and where you are/i)).toBeInTheDocument()
  })
  ...
  it('should explain why location permission is needed', () => {
    ...
    expect(screen.getByText(/we need access to your device's location/i)).toBeInTheDocument()
  })
  ...
  it('should assure user about privacy', () => {
    ...
    expect(screen.getByText(/Your location data stays on your device/i)).toBeInTheDocument()
  })
  ...
  it('should call onRequestPermission when button is clicked', async () => {
    ...
    const button = screen.getByRole('button', { name: /Enable Location Access/i })
  ...
  it('should inform user about browser prompt', () => {
    ...
    expect(screen.getByText(/You'll be prompted by your browser/i)).toBeInTheDocument()
  })
})
