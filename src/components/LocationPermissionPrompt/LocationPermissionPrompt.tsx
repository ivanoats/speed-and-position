  ...
  return (
    ...
    >
      ...
      <div className={cx(cardStyles.body, css({ textAlign: 'center' }))}>
        ...
        >
          This mapping app shows you how fast you're going and where you are in
          real-time.
        </p>
        ...
        >
          To provide this functionality, we need access to your device's
          location. Your location data stays on your device and is not shared
          with anyone.
        </p>
      </div>
