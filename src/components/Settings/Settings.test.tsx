...
describe('Settings', () => {
  it('renders when isOpen is true', () => {
    render(<Settings isOpen={true} onClose={vi.fn()} unit="mph" onUnitChange={vi.fn()} />)
  ...
  it('renders with hidden attribute when isOpen is false', () => {
    const { container } = render(<Settings isOpen={false} onClose={vi.fn()} unit="mph" onUnitChange={vi.fn()} />)
  ...
  it('displays KPH as selected when unit is kph', () => {
    render(<Settings isOpen={true} onClose={vi.fn()} unit="kph" onUnitChange={vi.fn()} />)
  ...
  it('calls onUnitChange when MPH button is clicked', async () => {
    ...
    render(<Settings isOpen={true} onClose={vi.fn()} unit="kph" onUnitChange={onUnitChange} />)
  ...
  it('calls onUnitChange when KPH button is clicked', async () => {
    const user = userEvent.setup()
    const onUnitChange = vi.fn()
    render(<Settings isOpen={true} onClose={vi.fn()} unit="mph" onUnitChange={onUnitChange} />)
  ...
  it('calls onClose when Close button is clicked', async () => {
    const user = userEvent.setup()
    const onClose = vi.fn()
    render(<Settings isOpen={true} onClose={onClose} unit="mph" onUnitChange={vi.fn()} />)
